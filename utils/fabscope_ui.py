...
class FabscopeUI:
    def __init__(self, core, dmd, channels, simulate=False, sleep_time=0.1, clim=(0, 255)):
        self.core = core
        self.dmd = dmd
    ...
    def acquire_data(self):
        ...
        img = img[::]
        self.img_queue.put([self.channels[1], img])
    ...
    def append_img(self):
        ...
        if not self.simulate:
            ...
            ii = 0
            while self.acq_running:
                # Implement simulate_data if needed
                ii += 1
                time.sleep(self.sleep_time)
    ...
    def initialize_viewer(self):
        ...
        self.layers = [self.viewer.add_image(
            self.data,
            name='zero',
            colormap='gray',
        ...
        self.viewer.window.add_dock_widget(
            magicgui(self.set_dmd_checkerboard, call_button="DMD Checkerboard pattern"),
            area='left'
        )
        self.viewer.window.add_dock_widget(
            magicgui(self.store_pos, call_button="Store position"),
            area='left'
        )
